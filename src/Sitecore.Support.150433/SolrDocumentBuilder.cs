...
namespace Sitecore.Support.ContentSearch.SolrProvider
{
    public class SolrDocumentBuilder : AbstractDocumentBuilder<ConcurrentDictionary<string, object>>
    {
        ...
        protected virtual void AddComputedIndexFieldsInParallel()
        {
            ...
            this.ParallelForeachProxy.ForEach<IComputedIndexField>((IEnumerable<IComputedIndexField>)base.Options.ComputedIndexFields, base.ParallelOptions, (Action<IComputedIndexField, ParallelLoopState>)((field, parallelLoopState) => this.AddComputedIndexField(field, parallelLoopState, exceptions)));
